...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\OneToMany(mappedBy: 'ownerId', targetEntity: Business::class)]
    ...
    public function setContrat(?array $contrat): self
    {
