 ...
 */
final class Version20230427142625 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE profile ADD wish LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', DROP user_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE profile ADD user_id INT DEFAULT NULL, DROP wish');
